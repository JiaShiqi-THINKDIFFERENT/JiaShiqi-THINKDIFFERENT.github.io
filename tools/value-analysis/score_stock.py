...
STOCKS = [
    ...
    ("601318", "zhongguo-pingan", "中国平安"),
    ("000001", "pingan-yinhang", "平安银行"),
    ("601628", "zhongguo-renshou", "中国人寿"),
    ("000651", "geli-dianqi", "格力电器"),
    ("600415", "xiaoshangpin-cheng", "小商品城"),
    ("000617", "zhongyou-ziben", "中油资本"),
    ("000725", "jingdongfang", "京东方A"),
    ("002475", "lixun-jingmi", "立讯精密"),
    ("002230", "keda-xunfei", "科大讯飞"),
    ("600019", "baogang-gufen", "宝钢股份"),
    ("600030", "zhongxin-zhengquan", "中信证券"),
    ("000792", "yanhu-gufen", "盐湖股份"),
    ("000988", "huagong-keji", "华工科技"),
    ("002027", "fenzhong-chuanmei", "分众传媒"),
    ("002602", "shiji-huatong", "世纪华通"),
    ("002625", "guangqi-jishu", "光启技术"),
    ("002714", "muyuan-gufen", "牧原股份"),
    ("300015", "aier-yanke", "爱尔眼科"),
    ("300124", "huichuan-jishu", "汇川技术"),
    ("300274", "yangguang-dianyuan", "阳光电源"),
    ("300476", "shenghong-keji", "胜宏科技"),
    ("300760", "mairui-yiliao", "迈瑞医疗"),
    ("600031", "sanyi-zhonggong", "三一重工"),
    ("600048", "baoli-fazhan", "保利发展"),
    ("600111", "beifang-xitu", "北方稀土"),
    ("600150", "zhongguo-chuanbo", "中国船舶"),
    ("600309", "wanhua-huaxue", "万华化学"),
    ("600406", "guodian-nanrui", "国电南瑞"),
    ("600585", "hailuo-shuini", "海螺水泥"),
    ("600660", "fuyao-boli", "福耀玻璃"),
    ("600893", "hangfa-dongli", "航发动力"),
    ("601088", "zhongguo-shenhua", "中国神华"),
    ("601668", "zhongguo-jianzhu", "中国建筑"),
    ("601816", "jinghu-gaotie", "京沪高铁"),
    ("601857", "zhongguo-shiyou", "中国石油"),
    ("601888", "zhongguo-zhongmian", "中国中免"),
    ("603993", "luoyang-muye", "洛阳钼业"),
    ("605499", "dongpeng-yinliao", "东鹏饮料"),
]
